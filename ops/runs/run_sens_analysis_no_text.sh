...
# if you want to append certain attributes (in case you went back and had to pre-process something extra..)
# ATC
# reuse_batchfiles=F \
...
#  include_medications=$INCLUDE_MEDICATIONS \
#  include_measurements=$INCLUDE_MEASUREMENTS \
#  infile=restored_pats_dict_merged_text_emb3 \
#  outfile=fs_flat_atc_only \
#  reuse_batchfiles=T \
#  derive_specific_attrs=tw_atc_code  >> $logfile && \
# python -u 4_pre_process.py $1 $2 \
#  infile=fs_flat \
#  append_attributes=tw_atc_code \
#  infile_append=fs_flat_atc_only \
#  infile_nbatches=restored_cluster_fs1_n_batches \
#  infile_pats_dict=pats_dict_merged\
#  outfile=cluster_fs1_csr >> $logfile && \
# python -u 4_pre_process.py $1 $2 \
#  infile=fs_flat \
#  append_attributes= \
#  infile_append= \
...
#  outfile=notxt_cluster_fs1_selected  \
#  use_text_vars=F>> $logfile && \
# python -u GMM_preprocess.py $1 $2 \
#  infile=notxt_cluster_fs1_selectedn_etors5000_maxepth5_minplit100_maxodes200  \
#  infile_code_lookups=cluster_fs1_lookup_dicts \
#  outfile=notxt_cluster_fs1_df_scaled \
#  plot_histograms=F >> $logfile && \
# python -u C_runner.py $1 $2  \
#  infile=notxt_cluster_fs1_df_scaled \
#  outfile=notxt_gmm_output  >> $logfile && \
python -u analyse_results.py $1 $2 \
  infile=_24_non-nested_notxt_gmm_output \
  outfile=24_notxt_analyse_results \
  goodness_of_fit_metric=inci \
  infile_scale_maxabs_lookup=temp_cluster_fs1_crs_scaled_scale_multipliers \
  infile_scale_robust_lookup=notxt_cluster_fs1_df_scaled_scale_multipliers \
  infile_fs1_ohe_lookup=cluster_fs1_lookup_dicts \
  infile_t2v_model=temp_pats_dict_merged_text_emb4 \
  plot_wordclouds=T >> $logfile && \

# python -u analyse_results.py $1 $2 \
#   infile=_7_other_nested_gmm_output \
#   outfile=7_othe_analyse_results \
#   goodness_of_fit_metric=inci \
#   infile_scale_maxabs_lookup=temp_cluster_fs1_crs_scaled_scale_multipliers \
#   infile_scale_robust_lookup=10x4_cluster_fs1_df_scaled_scale_multipliers \
#   infile_fs1_ohe_lookup=cluster_fs1_lookup_dicts \
#   infile_t2v_model=temp_pats_dict_merged_text_emb4 \
#   plot_wordclouds=F >> $logfile && \

# python -u analyse_results.py $1 $2 \
#   infile=_8_icpc_nested_gmm_output \
#   outfile=8_icpc_analyse_results \
#   goodness_of_fit_metric=inci \
#   infile_scale_maxabs_lookup=temp_cluster_fs1_crs_scaled_scale_multipliers \
#   infile_scale_robust_lookup=10x4_cluster_fs1_df_scaled_scale_multipliers \
#   infile_fs1_ohe_lookup=cluster_fs1_lookup_dicts \
...
#   plot_wordclouds=F >> $logfile && \
# python -u analyse_results.py $1 $2 \
#   infile=_10_atc_nested_gmm_output \
#   outfile=10_atc_analyse_results \
#   goodness_of_fit_metric=inci \
#   infile_scale_maxabs_lookup=temp_cluster_fs1_crs_scaled_scale_multipliers \
#   infile_scale_robust_lookup=10x4_cluster_fs1_df_scaled_scale_multipliers \
#   infile_fs1_ohe_lookup=cluster_fs1_lookup_dicts \
...
#   plot_wordclouds=F >> $logfile && \
# python -u analyse_results.py $1 $2 \
#   infile=_12_txt_nested_gmm_output \
#   outfile=12_txt_analyse_results \
#   goodness_of_fit_metric=inci \
#   infile_scale_maxabs_lookup=temp_cluster_fs1_crs_scaled_scale_multipliers \
#   infile_scale_robust_lookup=10x4_cluster_fs1_df_scaled_scale_multipliers \
#   infile_fs1_ohe_lookup=cluster_fs1_lookup_dicts \
